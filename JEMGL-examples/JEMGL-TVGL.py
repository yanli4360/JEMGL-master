# -*- coding: utf-8 -*-
"""
We investigate the JEMGL algorithm with Time-varying graph lasso.
"""


import numpy as np
from JEMGL.Helper.Data_generation import  sample_covariance_matrix,time_varying_graph
...
# graph construction
Sigma, Laplacian = time_varying_graph(p, K, M)
